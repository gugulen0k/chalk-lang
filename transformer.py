...
class ChalkTransformer(Transformer):
    ...
    def number(self, args):
        ...
        return Number(value=int(val) if val.is_integer() else val)

    def string(self, args):
        raw = str(args[0])

        return String(value=raw[1:-1])
    ...
    def func_call(self, args):
        ...
        return FuncCall(name=name, args=call_args)
    ...
    def var_decl(self, args):
        ...
        if isinstance(args[0], Token) and args[0] == self.MUTABLE_KEYWORD:
            mutable, name, type_, value = True, str(args[1]), str(args[2]), str(args[3])
        else:
        ...
        return VarDecl(name=name, type=type_, value=value, mutable=mutable)

    def assign(self, args):
        return Assign(name=str(args[0], value=args[1]))
    ...
    def return_stmt(self, args):
        return ReturnStmt(value=args[0])

    def print_stmt(self, args):
        return PrintStmt(value=args[0])

    def expr_stmt(self, args):
        return ExprStmt(value=args[0])
